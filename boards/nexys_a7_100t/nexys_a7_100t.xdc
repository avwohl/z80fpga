## Digilent Nexys A7-100T constraints for the z80fpga SoC.
##
## Pins taken from Digilent's Nexys-A7-100T-Master.xdc.  Only the 100 MHz clock
## is shared with the Arty A7-100T; do not copy anything else between the two.

set_property -dict {PACKAGE_PIN E3 IOSTANDARD LVCMOS33} [get_ports CLK100MHZ]
create_clock -period 10.000 -name sys_clk [get_ports CLK100MHZ]

## Dedicated active-low reset button (CPU_RESETN)
...
## USB-UART bridge, on channel B of the same FT2232 that programs the board
